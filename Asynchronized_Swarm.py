    ...
    with MotionCommander(scf, default_height=DEFAULT_HEIGHT) as mc:
        ...
        while time.time() < end_time:
            ...
            if scf.__dict__['_link_uri'] == URI1:
                mc.up(DEFAULT_HEIGHT, DEFAULT_VELOCITY)
                time.sleep(DEFAULT_SLEEP_TIME)
                mc.forward(1, DEFAULT_VELOCITY)
                time.sleep(DEFAULT_SLEEP_TIME)
                mc.right(1, DEFAULT_VELOCITY)
                time.sleep(DEFAULT_SLEEP_TIME)
                mc.back(1, DEFAULT_VELOCITY)
                time.sleep(DEFAULT_SLEEP_TIME)
                mc.left(1, DEFAULT_VELOCITY)
                time.sleep(DEFAULT_SLEEP_TIME)
                mc.circle_right(0.4, DEFAULT_VELOCITY, 720)
                time.sleep(2)
                ...
                mc.right(1, DEFAULT_VELOCITY)
                time.sleep(DEFAULT_SLEEP_TIME)
                mc.circle_left(0.4, DEFAULT_VELOCITY, 720)
                time.sleep(2)
